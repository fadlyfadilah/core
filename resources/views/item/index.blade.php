    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-separate table-head-custom table-checkable datatable-Item">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-clean btn-icon" data-toggle="modal"
                                            data-target="#modal-form-edit-menuItem-{{ $menuItem->id }}">
                                            <span class="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <a href="#" onclick="confirmDelete('{{ $menuItem->id }}')"
                                        ...
                                        @include('components.form.menuItem.delete')
                                        @include('components.form.menuItem.update')
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <!--end::Container-->
        @include('components.form.menuItem.add')
    </div>
    <!--end::Entry-->
@endsection
@section('scripts')
    ...
    <script>
        function confirmDelete(menuItemId) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    document.getElementById('modal-form-delete-menuItem-' + menuItemId).submit();
                }
            });
        }
    </script>
