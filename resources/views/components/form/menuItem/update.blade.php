<!-- Modals add menu -->
<div id="modal-form-edit-menuItem-{{ $menuItem->id }}" class="modal fade" tabindex="-1"
    aria-labelledby="modal-form-edit-menuItem-{{ $menuItem->id }}-label" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-content">
            <form action="{{ route('menu.item.update', [$menu->id, $menuItem->id]) }}" method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-form-edit-menuItem-{{ $menuItem->id }}-label">Edit Menu Item
                        ({{ $menuItem->name }})</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="icon"
                            placeholder="Remix Icon (eg: flaticon2-gear)" name="icon" value="{{ $menuItem->icon }}">
                    ...
                    <div class="form-group">
                        <label class="checkbox">
                            <input type="checkbox" value="1" @checked($menuItem->status) name="status" />
                            <span></span>
                            Status
                        </label>
