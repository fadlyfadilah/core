	...
	<div class=" container ">
		...
		<div class="row">
			<div class="col-xl-4">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-4","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/mixed/widget-4","page":"index"}]/-->
			</div>
			<div class="col-xl-8">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/base-tables/widget-6","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/base-tables/widget-6","page":"index"}]/-->
			</div>
		</div>
			...
			<div class="col-xl-4">
				<div class="row">
					...
					<div class="col-xl-12">
						...
						<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/stats/widget-10","page":"index"}]/-->
						...
						<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/stats/widget-10","page":"index"}]/-->
					</div>
				</div>
			</div>
			<div class="col-xl-8">

				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-14","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/lists/widget-14","page":"index"}]/-->
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12 col-xxl-12">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/advance-tables/widget-9","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/advance-tables/widget-9","page":"index"}]/-->
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xl-6">
				...
				<!--[html-partial:begin:{"id":"demo1/dist/inc/view/partials/content/widgets/base-tables/widget-1","page":"index"}]/-->
				...
				<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/widgets/base-tables/widget-1","page":"index"}]/-->
			</div>
		</div>
		...
		<!--[html-partial:end:{"id":"demo1/dist/inc/view/partials/content/dashboards/demo3","page":"index"}]/-->

		<!--[html-partial:end:{"id":"demo3/dist/inc/view/demos/pages/index","page":"index"}]/-->
	</div>
