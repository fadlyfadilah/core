    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-separate table-head-custom table-checkable datatable-role">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-clean btn-icon" data-toggle="modal"
                                            data-target="#modal-form-edit-role-{{ $role->id }}">
                                            <span class="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        @include('components.form.role.delete')
                                        @include('components.form.role.update')
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <!--end::Container-->
        @include('components.form.role.add')
    </div>
    <!--end::Entry-->
@endsection
@section('scripts')
