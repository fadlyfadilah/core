...
@section('content')
    ...
    <div class="d-flex flex-column-fluid">
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Route Management
                        </h3>
                    </div>
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-separate table-head-custom table-checkable datatable-Route">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Route</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-clean btn-icon" data-toggle="modal"
                                            data-target="#modal-form-edit-route-{{ $route->id }}">
                                            <span class="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <a href="#" onclick="confirmDelete('{{ $route->id }}')"
                                        ...
                                        @include('components.form.route.delete')
                                        @include('components.form.route.update')
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <!--end::Container-->
        @include('components.form.route.add')
    </div>
    <!--end::Entry-->
@endsection
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Route:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
